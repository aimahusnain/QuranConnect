    ...
    <main className="min-h-screen bg-gradient-to-br pt-24 from-green-600 via-green-500 to-emerald-400 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <header className="text-center mb-16 animate-fade-in-down">
          ...
          <p className="text-xl mb-8">Master the foundations of Quranic reading</p>
        </header>
        ...
        <div className="text-center animate-fade-in">
          ...
          <Link href="/contact" className="bg-white text-green-700 font-bold py-3 px-6 rounded-full hover:bg-green-100 transition duration-300 mr-4">
            Book a Free Trial
          </Link>
          <Link href="/pricing" className="bg-transparent border-2 border-white text-white font-bold py-3 px-6 rounded-full hover:bg-white hover:text-green-700 transition duration-300">
            View Pricing
          </Link>
        </div>
      </div>
