...
export default function TajweedCoursePage() {
  return (
    <main className="min-h-screen bg-gradient-to-br pt-24 from-purple-600 via-indigo-500 to-blue-400 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16 animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white text-purple-800 rounded-lg p-6 shadow-lg transform transition duration-500 hover:scale-105">
                <svg className="w-8 h-8 mb-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <section className="mb-16 animate-fade-in">
          ...
          <div className="bg-white text-purple-800 rounded-lg shadow-lg p-8">
        ...
        <div className="text-center animate-fade-in">
          ...
          <Link href="/free-tajweed-assessment" className="bg-white text-purple-700 font-bold py-3 px-6 rounded-full hover:bg-purple-100 transition duration-300 mr-4">
