    ...
    <main className="min-h-screen bg-gradient-to-br pt-24 from-[#095D41] via-[#288D74] to-blue-500 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {syllabus.map((item, index) => (
                <div key={index} className="flex items-center">
                  <div className="bg-emerald-600 text-white rounded-full w-10 h-10 flex items-center justify-center mr-4">
                    {item.unit}
                  </div>
        ...
        <div className="text-center animate-fade-in">
          ...
          <Link href="/islamic-knowledge-test" className="bg-white text-emerald-700 font-bold py-3 px-6 rounded-full hover:bg-emerald-100 transition duration-300 mr-4">
            Take Our Free Knowledge Test
          </Link>
          <Link href="/basic-islam-courses" className="bg-transparent border-2 border-white text-white font-bold py-3 px-6 rounded-full hover:bg-white hover:text-emerald-700 transition duration-300">
            View Course Details
          </Link>
        </div>
      </div>
