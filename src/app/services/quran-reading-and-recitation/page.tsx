  ...
  return (
    <main className="min-h-screen bg-gradient-to-br pt-24 from-blue-600 via-blue-500 to-indigo-400 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16 animate-fade-in">
          <h2 className="text-3xl font-bold mb-8 text-center">Course Levels</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {courseLevels.map((level, index) => (
              <div key={index} className="bg-white text-blue-800 rounded-lg shadow-lg p-8 transform transition duration-500 hover:scale-105">
        ...
        <div className="text-center animate-fade-in">
          <h2 className="text-3xl font-bold mb-4">Ready to Enhance Your Quranic Recitation?</h2>
          <p className="mb-8">Join our Quran Reading & Recitation course and embark on a journey to perfect your recitation.</p>
          <Link href="/contact" className="bg-white text-blue-700 font-bold py-3 px-6 rounded-full hover:bg-blue-100 transition duration-300 mr-4">
            Book a Free Trial
          </Link>
          <Link href="/pricing" className="bg-transparent border-2 border-white text-white font-bold py-3 px-6 rounded-full hover:bg-white hover:text-blue-700 transition duration-300">
            View Pricing
          </Link>
        </div>
      </div>
